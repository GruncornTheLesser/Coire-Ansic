...
template<typename T, typename U> struct get_template_attribute<T, attribute::NAME<U>, std::void_t<typename T::template NAME<U>>> 			\
 : std::type_identity<typename T::template NAME<U>> { }; 																					\
template<typename T, typename U, typename void_T> struct has_template_attribute<T, attribute::NAME<U>, void_T> : std::false_type { }; 		\
template<typename T, typename U> struct has_template_attribute<T, attribute::NAME<U>, std::void_t<typename T::template NAME<U>>>			\
 : std::true_type { };
